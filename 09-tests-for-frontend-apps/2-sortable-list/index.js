export default class SortableList {
        ...
        list.addEventListener("dragstart", (event) => {
            if ("grabHandle" in event.target.dataset) {
                ...
                list.addEventListener("dragover", (event) => {
                    ...
                    const activeItem = list.querySelector(".sortable-list__item_dragging");
                    const currentItem = event.target.closest("li");


                    const isDropble = activeItem !== currentItem && currentItem.classList.contains(`sortable-list__item`);

                    if (!isDropble) {
                        return;
                    }

                    const nextItem = this.getNextItem(event.clientY, currentItem);
    ...
    getNextItem(cursorPos, currentItem){
        ...
        const nextItem = (cursorPos < currentItemCenter) 
            ?currentItem
